  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#090a08] text-slate-100 antialiased">
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(rgba(226,232,240,0.045)_1px,transparent_1px),linear-gradient(90deg,rgba(226,232,240,0.045)_1px,transparent_1px)] bg-[size:80px_80px] opacity-60" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0,rgba(9,10,8,0.82)_72%)]" />
